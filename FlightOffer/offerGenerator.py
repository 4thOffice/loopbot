...
def getDeepLink(flightDetails, email_comment_id):
    ret_json = {"flightDetails": flightDetails, "email_comment_id": email_comment_id}
    command = f"/travelai createoffer {json.dumps(ret_json)}"
