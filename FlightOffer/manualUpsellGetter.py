...
upsold = get_upsell_offer(get_access_token(keys.amadeus_client_id, keys.amadeus_client_secret), offer, ["REFUNDABLE TICKET", "CHANGEABLE TICKET", "REFUNDS ANYTIME"], "ECONOMY", "Enterprise")
